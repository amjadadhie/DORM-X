              ...
              >
                ...
                <td className="overflow-hidden w-auto h-auto py-[36px] text-[10px] lg:text-[16px] xl:text-[20px] text-center">
                  <select
                    ...
                    className="rounded-lg text-[#4D82B6] border-[#4D82B6]"
                  >
                ...
                <td className="flex justify-center w-auto h-auto lg:py-[36px] py-[42px] align-middle items-center">
                  <select
                    defaultValue={order.petugasKebersihan}
                    placeholder="petugas"
                ...
                <td className="w-auto h-auto py-0">
                  <div className="w-full flex justify-center">
                    <button
                      onClick={() =>
                        handleSubmit(order.orderID, status, petugas)
                      }
                      className="w-[30px] h-[40px] rounded-full bg-[#11406A] text-white flex justify-center items-center px-10 font-semibold hover:shadow-[0_4px_4px_0px_rgba(0,0,0,0.25)]"
                    >
                      <p>Save</p>
                    </button>
                  </div>
