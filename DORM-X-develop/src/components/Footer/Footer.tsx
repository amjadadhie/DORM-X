...
const Footer = () => {
  return (
    <div>
      <footer className="bg-[#4D82B6] dark:bg-gray-900 ">
        <div className="mx-auto w-full   py-6 lg:py-8">
          <div className="md:flex md:justify-between px-8">
            ...
            <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              <div>
                ...
                <ul className="text-white font-xl">
                  <li className="">
                    <a href="#" className="">
                      Jl. Lorem Ipsum 10,
                    </a>
          ...
          <div className="sm:flex sm:items-center sm:justify-between px-8">
            <span className="text-lg text-white  sm:text-center ">
              ...
              . Tubes Layanan Sistem Teknologi Informasi.
            </span>
